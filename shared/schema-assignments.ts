...
export const assignments = pgTable("assignments", {
  ...
  lyzrAssetIds: jsonb("lyzr_asset_ids"), // Array of Lyzr asset IDs for uploaded files
});
...
export const assignmentCheckpointAttempts = pgTable(
  "assignment_checkpoint_attempts",
  {
    ...
    aiScore: integer("ai_score").$type<number>(), // CHECK constraint handled in migration
